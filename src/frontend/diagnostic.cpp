...
std::string serialize(const diagnostic_t &msg) {
  ...
  switch (msg.level) {
    case diagnostic_level_t::eError:  ss << ANSI_RED    << "error:";   break;
    case diagnostic_level_t::eWarn:   ss << ANSI_ORANGE << "warning:"; break;
    case diagnostic_level_t::eInfo:   ss << ANSI_BLUE   << "info:";    break;
  }
